...
(
  ...
  `MaintOrdActualExecutionStartDate`   varchar(20) DEFAULT NULL,
  `MaintOrdActualExecutionStartTime`   varchar(20) DEFAULT NULL,
  `MaintOrdActualExecutionEndDate`     varchar(20) DEFAULT NULL,
  `MaintOrdActualExecutionEndTime`     varchar(20) DEFAULT NULL,
